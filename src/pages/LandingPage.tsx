...
export const LandingPage: React.FC = () => {
  ...
  const annualSavingsEstimate = useMemo(() => {
    const safeOrders = Number.isFinite(ordersPerMonth) ? Math.min(Math.max(ordersPerMonth, 1), 50) : 1;
    const safeOrderValue = Number.isFinite(averageOrderValue) ? Math.min(Math.max(averageOrderValue, 10), 5000) : 10;
    ...
    <main className="lp-page">
      <section className="lp-hero">
        ...
        <div className="lp-hero-left">
          ...
          <p className="lp-lead">
            Most tools stop at checkout. AfterSave keeps protecting your order until your return
            window ends.
          </p>
      ...
      <section className="lp-section" id="lp-problem">
        ...
        <p>
          Prices still move. Refund policies are inconsistent. You either lose money or spend time
          manually canceling and re-buying.
        </p>
      ...
      <section className="lp-section">
        ...
        <div className="lp-faq">
          <article>
            ...
            <p>
              We only monitor order confirmations in your authenticated session and extract
